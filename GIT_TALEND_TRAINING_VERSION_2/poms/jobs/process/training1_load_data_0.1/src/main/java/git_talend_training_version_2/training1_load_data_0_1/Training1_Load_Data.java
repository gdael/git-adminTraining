...
package git_talend_training_version_2.training1_load_data_0_1;
...
/**
 * Job: Training1_Load_Data Purpose: <br>
 * Description:  <br>
 * @author Dael, Glenn Marvin
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Training1_Load_Data implements TalendJob {
	static {System.setProperty("TalendJob.log", "Training1_Load_Data.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Training1_Load_Data.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Training1_Load_Data";
	private final String projectName = "GIT_TALEND_TRAINING_VERSION_2";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_vnFiYCebEe6XC6Ldt-_NrQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Training1_Load_Data.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Training1_Load_Data.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Training1_Load_Data.class.getClassLoader()
					.getResourceAsStream("git_talend_training_version_2/training1_load_data_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Training1_Load_Data.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_GIT_TALEND_TRAINING_VERSION_2_Training1_Load_Data = new byte[0];
    static byte[] commonByteArray_GIT_TALEND_TRAINING_VERSION_2_Training1_Load_Data = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GIT_TALEND_TRAINING_VERSION_2_Training1_Load_Data) {
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"D:/Qlik Data Integration/Talend/Sample Data/Sample.xlsx\"");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "D:/Qlik Data Integration/Talend/Sample Data/Sample.xlsx";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("D:/Qlik Data Integration/Talend/Sample Data/Sample.xlsx", "ISO-8859-15",";","\n",true,0,0,
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("D:/Qlik Data Integration/Talend/Sample Data/Sample.xlsx") instanceof java.io.InputStream)){
 ...
 */
    ...
    public static void main(String[] args){
        final Training1_Load_Data Training1_Load_DataClass = new Training1_Load_Data();

        int exitCode = Training1_Load_DataClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Training1_Load_Data' - Done.");
	        }
    ...
    private void readJobInfo(java.io.File jobInfoFile){
		...
		log.info(String.format("Project name: %s\tJob name: %s\tGIT Commit ID: %s\tTalend Version: %s",
				projectName,jobName,jobInfo.getProperty("gitCommitId"), "8.0.1.20211109_1610"));
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'Training1_Load_Data' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_vnFiYCebEe6XC6Ldt-_NrQ");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-07-21T07:27:58.403343500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Training1_Load_Data.class.getClassLoader().getResourceAsStream("git_talend_training_version_2/training1_load_data_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Training1_Load_Data.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'Training1_Load_Data' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Training1_Load_Data");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'Training1_Load_Data' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     60541 characters generated by Talend Real-time Big Data Platform 
 *     on the 21 July 2023 at 3:27:58 PM SGT
 ************************************************************************************************/